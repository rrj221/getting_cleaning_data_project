...
5. From the data set in step 4, creates a second, independent tidy data set with the average of each variable for each activity and each subject.
   ...
   * write.table() is used to write the summary to a txt file and save it in the main directory
   * write.csv() is used to write the summary to a csv file and save it in the main directory